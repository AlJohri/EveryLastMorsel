# RailsAdmin config file. Generated on July 10, 2013 18:29
...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = ['Blogit::Comment', 'Blogit::Post', 'Follow', 'Plot', 'Role', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Blogit::Comment', 'Blogit::Post', 'Follow', 'Plot', 'Role', 'User']
  ...
  #     configure :blogger, :polymorphic_association 
  ...
  #     configure :follower, :polymorphic_association         # Hidden 
  ...
  #     configure :blog_posts, :has_many_association 
