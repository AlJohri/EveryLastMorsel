...
if Rails.env.development?
	...
	BraintreeRails::Configuration.environment = ENV["BRAINTREE_SANDBOX_ENVIRONMENT"].to_sym
	...
	BraintreeRails::Configuration.environment = ENV["BRAINTREE_ENVIRONMENT"].to_sym
