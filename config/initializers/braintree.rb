...
if Rails.env.development?
	Braintree::Configuration.environment = ENV["BRAINTREE_SANDBOX_ENVIRONMENT"].try(:to_sym)
	...
	BraintreeRails::Configuration.environment = ENV["BRAINTREE_SANDBOX_ENVIRONMENT"].try(:to_sym)
	...
	Braintree::Configuration.environment = ENV["BRAINTREE_ENVIRONMENT"].try(:to_sym)
	Braintree::Configuration.merchant_id = ENV["BRAINTREE_MERCHANT_ID"]
	Braintree::Configuration.public_key  = ENV["BRAINTREE_PUBLIC_KEY"]
	Braintree::Configuration.private_key = ENV["BRAINTREE_PRIVATE_KEY"]

	BraintreeRails::Configuration.environment = ENV["BRAINTREE_ENVIRONMENT"].try(:to_sym)
